...
namespace ReceiptProcessorChallenege_Testing
{
    public class MMReceiptTests
    {
        ...
        public void Setup()
        {
            using(StreamReader r = new("Json/MMReceipt.json"))
            {
        ...
        {
            Assert.That(alphaRule.CalculatePoints(targetReceipt), Is.EqualTo(14));
        }
        ...
        {
            Assert.That(purchaseTimeRule.CalculatePoints(targetReceipt), Is.EqualTo(10));
        }
        ...
        {
            Assert.That(totalIsWholeRule.CalculatePoints(targetReceipt), Is.EqualTo(50));
        }
    }
}
