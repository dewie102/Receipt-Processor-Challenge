...
{
    public class MorningReceiptTest
    {
        ...
        public void Setup()
        {
            using(StreamReader r = new("Json/MorningReceipt.json"))
            {
        ...
        {
            Assert.That(alphaRule.CalculatePoints(targetReceipt), Is.EqualTo(9));
        }

        [Test]
        public void TargetReceiptEveryTwoItems()
        {
            Assert.That(everyTwoItemsRule.CalculatePoints(targetReceipt), Is.EqualTo(5));
        }

        [Test]
        public void TargetReceiptItemDescriptionLength()
        {
            Assert.That(itemDescriptionRule.CalculatePoints(targetReceipt), Is.EqualTo(1));
        }
