...
{
    public class TargetReceiptTests
    {
        ...
        public void Setup()
        {
            using(StreamReader r = new("Json/TargetReceipt.json"))
            {
        ...
        {
            Assert.That(everyTwoItemsRule.CalculatePoints(targetReceipt), Is.EqualTo(10));
        }

        [Test]
        public void TargetReceiptItemDescriptionLength()
        {
            Assert.That(itemDescriptionRule.CalculatePoints(targetReceipt), Is.EqualTo(6));
        }

        [Test]
        public void TargetReceiptPurchaseDate()
        {
            Assert.That(purchaseDateRule.CalculatePoints(targetReceipt), Is.EqualTo(6));
        }
        ...
        {
            Assert.That(totalIsMultipleRule.CalculatePoints(targetReceipt), Is.EqualTo(0));
        }
